 ...
 * Created by alexar.
 */
public class GuruEndpoint extends DefaultEndpoint {
    ...
    public GuruEndpoint(DateManager dateManager) {
        super();
    ...
    public Producer createProducer() throws Exception {
        return new GuruProducer(this, apiSearchUrl, start, limit, dateManager);
    }

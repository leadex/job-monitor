package ru.leadexsystems.startup.jobmonitor.guru;
...
import ru.leadexsystems.startup.jobmonitor.guru.component.GuruComponent;
...
public class GuruJobMonitorApplication {
    ...
    @Bean
    public GuruComponent guru() {
        return new GuruComponent(new DbManager(host, port, db, login, password));
    }
    ...
    public static void main(String[] args) {
        SpringApplication.run(GuruJobMonitorApplication.class, args);
    }
}

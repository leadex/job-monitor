package ru.leadexsystems.startup.jobmonitor.upwork;
...
import ru.leadexsystems.startup.jobmonitor.upwork.component.UpworkComponent;
...
public class UpworkJobMonitorApplication {
    ...
    @Bean
    public UpworkComponent upwork() {
        return new UpworkComponent(new DbManager(host, port, db, login, password));
    }
    ...
    public static void main(String[] args) {
        SpringApplication.run(UpworkJobMonitorApplication.class, args);
    }
}
